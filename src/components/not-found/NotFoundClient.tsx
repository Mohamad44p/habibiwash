          ...
          <div className="relative bg-card/50 backdrop-blur-xl border border-primary/20 rounded-2xl p-8 md:p-12 shadow-2xl overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              ...
              >
                <Badge
                  variant="secondary"
                  className="bg-primary/10 hover:bg-primary/20 transition-all duration-300 px-4 py-1.5 text-sm font-medium shadow-lg"
                >
                  <motion.span
                  ...
                  <span className="ml-2">404 Not Found</span>
                </Badge>
              </motion.div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-background to-card rounded-full p-6 border border-primary/20 shadow-lg">
              ...
              >
                ...
                <p className="text-lg text-muted-foreground">
                  The page you&apos;re looking for has been moved or
                  doesn&apos;t exist.
                </p>
              </motion.div>
